...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/GoogleCamera/privapp-permissions-org.codeaurora.snapcam.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/permissions/privapp-permissions-org.codeaurora.snapcam.xml \
    $(LOCAL_PATH)/configs/GoogleCamera/privapp-permissions-com.google.android.GoogleCamera.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/permissions/privapp-permissions-com.google.android.GoogleCamera.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/OnePlusCamera/hiddenapi-package-whitelist-oneplus.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/sysconfig/hiddenapi-package-whitelist-oneplus.xml \
    $(LOCAL_PATH)/configs/OnePlusCamera/privapp-permissions-com.oneplus.camera.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/permissions/privapp-permissions-com.oneplus.camera.xml \
    $(LOCAL_PATH)/configs/OnePlusCamera/privapp-permissions-com.oneplus.camera.service.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/permissions/privapp-permissions-com.oneplus.camera.service.xml \
    $(LOCAL_PATH)/configs/OnePlusCamera/privapp-permissions-com.oneplus.gallery.xml:$(TARGET_COPY_OUT_SYSTEM)/product/etc/permissions/privapp-permissions-com.oneplus.gallery.xml
